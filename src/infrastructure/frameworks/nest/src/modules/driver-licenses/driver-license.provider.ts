...
export const ListDriverLicensesUseCaseProvider = {
  ...
  useFactory: (driverLicenseRepositoryReader: DriverLicenseRepositoryReader) => new ListDriverLicensesQueryHandler(driverLicenseRepositoryReader),
...
export const GetDriverLicenseByIdentifierUseCaseProvider = {
  ...
  useFactory: (driverLicenseRepositoryReader: DriverLicenseRepositoryReader) => new GetDriverLicenseByIdentifierQueryHandler(driverLicenseRepositoryReader),
  inject: [DriverLicenseRepositoryReader],
};

export const CreateDriverLicenseUseCaseProvider = {
  provide: CreateDriverLicenseUseCase,
  useFactory: (driverLicenseRepositoryWriter: DriverLicenseRepositoryWriter) => new CreateDriverLicenseCommandHandler(driverLicenseRepositoryWriter),
  inject: [DriverLicenseRepositoryWriter],
};

export const UpdateDriverLicenseUseCaseProvider = {
  provide: UpdateDriverLicenseUseCase,
  useFactory: (driverLicenseRepositoryWriter: DriverLicenseRepositoryWriter) => new UpdateDriverLicenseCommandHandler(driverLicenseRepositoryWriter),
  inject: [DriverLicenseRepositoryWriter],
};

export const DeleteDriverLicenseUseCaseProvider = {
  provide: DeleteDriverLicenseUseCase,
  useFactory: (driverLicenseRepositoryWriter: DriverLicenseRepositoryWriter) => new DeleteDriverLicenseCommandHandler(driverLicenseRepositoryWriter),
  inject: [DriverLicenseRepositoryWriter],
};
