...
export const GetDriverByIdentifierUseCaseProvider = {
  ...
  useFactory: (driverRepositoryReader: DriverRepositoryReader) => new GetDriverByIdentifierQueryHandler(driverRepositoryReader),
  inject: [DriverRepositoryReader],
};

export const CreateDriverUseCaseProvider = {
  provide: CreateDriverUseCase,
  useFactory: (driverRepositoryWriter: DriverRepositoryWriter) => new CreateDriverCommandHandler(driverRepositoryWriter),
  inject: [DriverRepositoryWriter],
};

export const UpdateDriverUseCaseProvider = {
  provide: UpdateDriverUseCase,
  useFactory: (driverRepositoryWriter: DriverRepositoryWriter) => new UpdateDriverCommandHandler(driverRepositoryWriter),
  inject: [DriverRepositoryWriter],
};

export const DeleteDriverUseCaseProvider = {
  provide: DeleteDriverUseCase,
  useFactory: (driverRepositoryWriter: DriverRepositoryWriter) => new DeleteDriverCommandHandler(driverRepositoryWriter),
  inject: [DriverRepositoryWriter],
};
