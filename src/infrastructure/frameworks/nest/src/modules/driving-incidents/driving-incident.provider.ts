...
export const ListDrivingIncidentsUseCaseProvider = {
  ...
  useFactory: (drivingIncidentRepositoryReader: DrivingIncidentRepositoryReader) =>
    new ListDrivingIncidentsQueryHandler(drivingIncidentRepositoryReader),
...
export const GetDrivingIncidentByIdentifierUseCaseProvider = {
  ...
  useFactory: (drivingIncidentRepositoryReader: DrivingIncidentRepositoryReader) =>
    new GetDrivingIncidentByIdentifierQueryHandler(drivingIncidentRepositoryReader),
  inject: [DrivingIncidentRepositoryReader],
};

export const CreateDrivingIncidentUseCaseProvider = {
  provide: CreateDrivingIncidentUseCase,
  useFactory: (drivingIncidentRepositoryWriter: DrivingIncidentRepositoryWriter) =>
    new CreateDrivingIncidentCommandHandler(drivingIncidentRepositoryWriter),
...
export const UpdateDrivingIncidentUseCaseProvider = {
  ...
  useFactory: (drivingIncidentRepositoryWriter: DrivingIncidentRepositoryWriter) =>
    new UpdateDrivingIncidentCommandHandler(drivingIncidentRepositoryWriter),
  inject: [DrivingIncidentRepositoryWriter],
};
...
export const DeleteDrivingIncidentUseCaseProvider = {
  ...
  useFactory: (drivingIncidentRepositoryWriter: DrivingIncidentRepositoryWriter) =>
    new DeleteDrivingIncidentCommandHandler(drivingIncidentRepositoryWriter),
  inject: [DrivingIncidentRepositoryWriter],
};
