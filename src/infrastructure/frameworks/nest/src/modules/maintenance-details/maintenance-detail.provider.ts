...
export const ListMaintenanceDetailsUseCaseProvider = {
  ...
  useFactory: (maintenanceDetailRepositoryReader: MaintenanceDetailRepositoryReader) => new ListMaintenanceDetailsQueryHandler(maintenanceDetailRepositoryReader),
...
export const GetMaintenanceDetailByIdentifierUseCaseProvider = {
  ...
  useFactory: (maintenanceDetailRepositoryReader: MaintenanceDetailRepositoryReader) => new GetMaintenanceDetailByIdentifierQueryHandler(maintenanceDetailRepositoryReader),
  inject: [MaintenanceDetailRepositoryReader],
};

export const CreateMaintenanceDetailUseCaseProvider = {
  provide: CreateMaintenanceDetailUseCase,
  useFactory: (maintenanceDetailRepositoryWriter: MaintenanceDetailRepositoryWriter) => new CreateMaintenanceDetailCommandHandler(maintenanceDetailRepositoryWriter),
...
export const UpdateMaintenanceDetailUseCaseProvider = {
  ...
  useFactory: (maintenanceDetailRepositoryWriter: MaintenanceDetailRepositoryWriter) => new UpdateMaintenanceDetailCommandHandler(maintenanceDetailRepositoryWriter),
  inject: [MaintenanceDetailRepositoryWriter],
};

export const DeleteMaintenanceDetailUseCaseProvider = {
  provide: DeleteMaintenanceDetailUseCase,
  useFactory: (maintenanceDetailRepositoryWriter: MaintenanceDetailRepositoryWriter) => new DeleteMaintenanceDetailCommandHandler(maintenanceDetailRepositoryWriter),
  inject: [MaintenanceDetailRepositoryWriter],
};
